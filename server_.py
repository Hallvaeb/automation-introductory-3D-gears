		...
		if path.find("/setRadius") != -1:
			...
			try:
				if FusekiHandler.is_gearBox_in_db(radius_list):
					...
					out += '<img src="/image.png" alt= "The gearbox was found in the database, but a photo has not yet been created. Our magnificent Johanne is working hard to make a photo of it available ASAP.">'
					gearBox_photo_name = ""
				else:
